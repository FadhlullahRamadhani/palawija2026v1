...
var style_RekapKecamatan_39 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (exp_label_RekapKecamatan_39_eval_expression(context) !== null) {
            labelText = String(exp_label_RekapKecamatan_39_eval_expression(context));
        }
