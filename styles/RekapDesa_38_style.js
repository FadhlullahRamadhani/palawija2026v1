...
var style_RekapDesa_38 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (exp_label_RekapDesa_38_eval_expression(context) !== null) {
            labelText = String(exp_label_RekapDesa_38_eval_expression(context));
        }
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 3.0 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(231,103,25,1.0)'})}),
