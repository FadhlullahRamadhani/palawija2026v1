    ...
    element: (() => {
        ...
        if (679 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Aplikasi Peta Indeks Pertanamanan Palawija 2025-2026 di Lahan Non Sawah dan Perkebunan merupakan sistem pemantauan pertanian berbasis citra satelit Sentinel-2 yang memanfaatkan indeks vegetasi NDVI (Normalized Difference Vegetation Index) untuk mengidentifikasi dan memantau pertumbuhan tanaman palawija seperti jagung, kedelai, dan kacang tanah. Melalui analisis perubahan nilai NDVI dari waktu ke waktu, sistem dapat menggambarkan pola tanam, intensitas pertanaman, serta perkembangan kondisi tanaman di suatu wilayah. Hasil pemantauan disajikan dalam bentuk peta interaktif yang mudah dipahami dan dapat digunakan untuk mendukung perencanaan serta evaluasi kegiatan pertanian.';
            }
